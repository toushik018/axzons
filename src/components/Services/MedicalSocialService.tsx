  ...
  return (
    <>
      <section className="w-full max-w-[1920px] bg-[#F3FFF0] relative overflow-hidden py-8 sm:py-12 md:py-16 lg:py-20">
        <div className="flex flex-col items-start px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-[160px] gap-4 sm:gap-6 md:gap-8 lg:gap-10 relative z-10">
          ...
          <div className="w-full lg:w-[70%] xl:w-[648px]">
            <p className="text-sm sm:text-base md:text-lg lg:text-[18px] font-normal leading-relaxed sm:leading-[23px] text-black">
              Our medical social services provide holistic support addressing
              the social and emotional needs of our clients. We offer
              counseling, resource coordination, and advocacy to ensure
              comprehensive care.
            </p>
          </div>
        ...
        <div className=" md:absolute w-full md:w-[480px] lg:w-[580px] xl:w-[680px] 2xl:w-[780px] h-[300px] md:h-[400px] lg:h-[500px] xl:h-[600px] 2xl:h-[700px] md:right-[0%] lg:right-0 xl:right-[0%] 2xl:right-[0%] md:top-[-25%]">
          <div className="relative w-full h-full">
            <Image
              src="/images/services/MedicalSocialService.png"
