...
export default function JointCommissionCertification() {
  return (
    <section className="relative w-full max-w-[1920px] mx-auto bg-gradient-to-br from-[rgba(170,134,196,0.7)] via-[rgba(255,255,255,0.7)] to-[rgba(231,153,166,0.7)]">
      <div className="flex flex-col lg:flex-row justify-between items-center p-6 sm:p-10 lg:p-20 xl:p-[80px_160px] gap-8 lg:gap-16 xl:gap-[132px]">
        <div className="flex flex-col items-start gap-8 lg:gap-10 w-full max-w-[753px]">
          <div className="relative">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight text-[#222222] mb-2 sm:mb-4">
          ...
          <p className="text-base sm:text-lg lg:text-xl font-normal leading-relaxed text-black mt-8 lg:mt-16">
